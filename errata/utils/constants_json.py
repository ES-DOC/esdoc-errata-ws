...
JF_EXPERIMENT = 'experiment_id'
JF_INSTITUTION_ID = 'institution_id'
...
FACET_TYPE_JSON_FIELD = {
	...
	FACET_TYPE_INSTITUTION_ID: JF_INSTITUTION_ID,
	FACET_TYPE_MODEL: JF_MODEL,
	FACET_TYPE_MIP_ERA: JF_MIP_ERA,
